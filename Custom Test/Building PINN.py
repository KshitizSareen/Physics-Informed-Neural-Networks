...
# === Data Loading ===
def load_data(filepath="temperature_output copy 5.csv"):
...
def prepare_training_data(df):
    ...
    return (
        ...
        sorted(xValues), sorted(yValues), sorted(tValues),all_coords
    )



df = load_data()
data,xValues,yValues,tValues,coords_array = prepare_training_data(df)
